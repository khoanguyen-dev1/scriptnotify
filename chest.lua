...
local Toggle = Tabs.tp:AddToggle("Dịch Chuyển Đến Đảo", { Title = "Dịch Chuyển Đến Đảo", Default = false })
...
local Toggle = Tabs.set:AddToggle("Bring Mob", { Title = "Bring Mob", Default = true })
Toggle:OnChanged(function(Value)
